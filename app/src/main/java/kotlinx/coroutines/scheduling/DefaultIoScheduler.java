...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo2243dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo2243dispatch(CoroutineContext context, Runnable block) {
        default.mo2243dispatch(context, block);
    }
