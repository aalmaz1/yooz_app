...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM684constructorimpl = Result.m684constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2198boximpl(Result.m691isSuccessimpl(objM684constructorimpl) ? ChannelResult.INSTANCE.m2213successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2211closedJP2dKIU(Result.m687exceptionOrNullimpl(objM684constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2188trySendJP2dKIU = sendChannel.mo2188trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2208isSuccessimpl(sendChannel.mo2188trySendJP2dKIU(obj))) {
            return;
        }
