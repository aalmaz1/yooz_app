...
public interface SendChannel<E> {
    ...
    Object mo2188trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2208isSuccessimpl(objMo2188trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2202exceptionOrNullimpl = ChannelResult.m2202exceptionOrNullimpl(objMo2188trySendJP2dKIU);
