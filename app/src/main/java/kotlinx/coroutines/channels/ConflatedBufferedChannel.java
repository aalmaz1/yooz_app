...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2216trySendImplMj0NB7M = conflatedBufferedChannel.m2216trySendImplMj0NB7M(e, true);
        if (objM2216trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2202exceptionOrNullimpl(objM2216trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2216trySendImplMj0NB7M = conflatedBufferedChannel.m2216trySendImplMj0NB7M(e, true);
        if (!(objM2216trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2188trySendJP2dKIU(E element) {
        return m2216trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2216trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2214trySendDropLatestMj0NB7M(element, isSendOp) : m2215trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2214trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2188trySendJP2dKIU = super.mo2188trySendJP2dKIU(element);
        if (ChannelResult.m2208isSuccessimpl(objMo2188trySendJP2dKIU) || ChannelResult.m2206isClosedimpl(objMo2188trySendJP2dKIU)) {
            return objMo2188trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2213successJP2dKIU(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2215trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2211closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2188trySendJP2dKIU = mo2188trySendJP2dKIU(element);
        if (!(objMo2188trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2188trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2202exceptionOrNullimpl(objMo2188trySendJP2dKIU);
