...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2192receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2192receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2193tryReceivePtdJZtk() {
        return this._channel.mo2193tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2188trySendJP2dKIU(E element) {
        return this._channel.mo2188trySendJP2dKIU(element);
    }
