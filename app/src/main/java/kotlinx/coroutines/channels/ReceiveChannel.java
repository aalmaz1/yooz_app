...
public interface ReceiveChannel<E> {
    ...
    Object mo2192receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2193tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2193tryReceivePtdJZtk = receiveChannel.mo2193tryReceivePtdJZtk();
            if (ChannelResult.m2208isSuccessimpl(objMo2193tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2204getOrThrowimpl(objMo2193tryReceivePtdJZtk);
            }
            Throwable thM2202exceptionOrNullimpl = ChannelResult.m2202exceptionOrNullimpl(objMo2193tryReceivePtdJZtk);
            if (thM2202exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2202exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2192receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2203getOrNullimpl(r4)
                return r4
            */
