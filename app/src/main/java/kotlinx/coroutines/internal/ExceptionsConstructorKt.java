...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM684constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM684constructorimpl = Result.m684constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m690isFailureimpl(objM684constructorimpl)) {
                objM684constructorimpl = null;
            }
            return (E) objM684constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM684constructorimpl = Result.m684constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m690isFailureimpl(objM684constructorimpl) ? null : objM684constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM684constructorimpl = Result.m684constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m690isFailureimpl(objM684constructorimpl)) {
            objM684constructorimpl = numValueOf;
        }
        return ((Number) objM684constructorimpl).intValue();
    }
