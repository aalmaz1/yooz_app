...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM684constructorimpl2;
        ...
        try {
            ...
            objM684constructorimpl = Result.m684constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m687exceptionOrNullimpl(objM684constructorimpl) == null) {
            obj2 = objM684constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM684constructorimpl2 = Result.m684constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM684constructorimpl2 = Result.m684constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m687exceptionOrNullimpl(objM684constructorimpl2) == null) {
            obj = objM684constructorimpl2;
        }
