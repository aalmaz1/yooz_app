...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM684constructorimpl = Result.m684constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m690isFailureimpl(objM684constructorimpl) ? null : objM684constructorimpl);
