    ...
    private final class Core {
        ...
        private final class KeyValueIterator<E> implements Iterator<E>, KMutableIterator {
            ...
            public E next() {
                ...
                K k = this.key;
                if (k == false) {
                    Intrinsics.throwUninitializedPropertyAccessException(NotificationConstant.EXTRA_KEY);
                    k = (K) Unit.INSTANCE;
                }
                V v = this.value;
                if (v == false) {
