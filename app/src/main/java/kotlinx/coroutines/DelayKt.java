...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2244scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2174delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2175toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2175toDelayMillisLRDsOJo(long j) {
        if (Duration.m2009compareToLRDsOJo(j, Duration.INSTANCE.m2113getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2028getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
