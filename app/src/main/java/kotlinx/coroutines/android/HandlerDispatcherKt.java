...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM684constructorimpl = Result.m684constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM684constructorimpl = Result.m684constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m690isFailureimpl(objM684constructorimpl) ? null : objM684constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2243dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
