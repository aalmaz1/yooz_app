    ...
    final class ImageReaderSurfaceProducer implements TextureRegistry.SurfaceProducer, TextureRegistry.ImageConsumer {
        ...
        private final ImageReader.OnImageAvailableListener onImageAvailableListener = new ImageReader.OnImageAvailableListener() { // from class: io.flutter.embedding.engine.renderer.FlutterRenderer.ImageReaderSurfaceProducer.1
            ...
            public void onImageAvailable(ImageReader imageReader) {
                ...
                ImageReaderSurfaceProducer.this.onImage(ImageReaderSurfaceProducer.this.new PerImage(imageReader, imageAcquireLatestImage));
            }
        };
        ...
        private ImageReader createImageReader29() {
            ImageReader imageReaderNewInstance = ImageReader.newInstance(this.requestedWidth, this.requestedHeight, 34, 4, 256L);
