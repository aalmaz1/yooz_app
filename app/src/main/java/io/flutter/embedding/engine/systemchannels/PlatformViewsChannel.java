...
public class PlatformViewsChannel {
    ...
    class AnonymousClass1 implements MethodChannel.MethodCallHandler {
        ...
        private void create(MethodCall methodCall, MethodChannel.Result result) {
            ...
            try {
                if (z2) {
                    PlatformViewsChannel.this.handler.createForPlatformViewLayer(new PlatformViewCreationRequest(((Integer) map.get("id")).intValue(), (String) map.get("viewType"), AudioStats.AUDIO_AMPLITUDE_NONE, AudioStats.AUDIO_AMPLITUDE_NONE, AudioStats.AUDIO_AMPLITUDE_NONE, AudioStats.AUDIO_AMPLITUDE_NONE, ((Integer) map.get("direction")).intValue(), PlatformViewCreationRequest.RequestedDisplayMode.HYBRID_ONLY, byteBufferWrap));
                    result.success(null);
                    return;
                }
                ...
                result.error(Constant.PARAM_ERROR, PlatformViewsChannel.detailedExceptionString(e), null);
            }
        }
        ...
        static /* synthetic */ void lambda$resize$0(MethodChannel.Result result, PlatformViewBufferSize platformViewBufferSize) {
            if (platformViewBufferSize == null) {
                result.error(Constant.PARAM_ERROR, "Failed to resize the platform view", null);
                return;
            }
        ...
        private void touch(MethodCall methodCall, MethodChannel.Result result) {
            ...
            try {
                ...
                try {
                    ...
                    e = e;
                    result2.error(Constant.PARAM_ERROR, PlatformViewsChannel.detailedExceptionString(e), null);
                }
