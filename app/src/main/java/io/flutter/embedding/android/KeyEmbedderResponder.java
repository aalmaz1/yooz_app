...
public class KeyEmbedderResponder implements KeyboardManager.Responder {
                ...
                if (i3 != 1) {
                        ...
                        if (!z) {
                            arrayList.add(new Runnable() { // from class: io.flutter.embedding.android.KeyEmbedderResponder$$ExternalSyntheticLambda2
                                ...
                                public final void run() {
                                    this.f$0.m654xa7448bcd(keyPair, keyEvent);
                                }
                            });
                        }
                        boolArr[i2] = Boolean.valueOf(zArr[i2]);
                    ...
                    if (!z) {
                        arrayList.add(new Runnable() { // from class: io.flutter.embedding.android.KeyEmbedderResponder$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.m653x63b96e0c(keyPair, j2, keyEvent);
                            }
                        });
                    }
                }
    ...
    /* synthetic */ void m653x63b96e0c(KeyboardMap.KeyPair keyPair, long j, KeyEvent keyEvent) {
    ...
    /* synthetic */ void m654xa7448bcd(KeyboardMap.KeyPair keyPair, KeyEvent keyEvent) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x014a A[LOOP:2: B:68:0x0144->B:70:0x014a, LOOP_END] */
    /*
