...
public final class Result<T> implements Serializable {
    ...
    public static <T> Object m684constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m689hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m691isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m690isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m688getOrNullimpl(Object obj) {
        if (m690isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static String m692toStringimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m684constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m684constructorimpl(ResultKt.createFailure(exception));
        }
    }
