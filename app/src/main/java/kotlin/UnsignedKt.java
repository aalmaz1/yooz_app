...
public final class UnsignedKt {
    ...
    public static final int m1035uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m779constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }
    ...
    public static final long m1037ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m858constructorimpl(0L) : ULong.m858constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m858constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m858constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m858constructorimpl(j - (j3 * j2)), ULong.m858constructorimpl(j2)) < 0 ? 0 : 1)));
    }
    ...
    public static final long m1038ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m858constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m858constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m858constructorimpl(j3), ULong.m858constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m858constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m779constructorimpl((int) d);
        }
        return UInt.m779constructorimpl(UInt.m779constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m779constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m858constructorimpl((long) d);
        }
        return ULong.m858constructorimpl(ULong.m858constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
