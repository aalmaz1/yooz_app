...
public final class UStringsKt {
    ...
    public static final String m1997toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1999toStringolVBNx4(short s, int i) {
    ...
    public static final String m1998toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1996toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m779constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m696boximpl(UByte.m702constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m779constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m959boximpl(UShort.m965constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM779constructorimpl = UInt.m779constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM779constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM779constructorimpl2 = UInt.m779constructorimpl(i3 * iM779constructorimpl);
            int iM779constructorimpl3 = UInt.m779constructorimpl(UInt.m779constructorimpl(iDigitOf) + iM779constructorimpl2);
            if (Integer.compareUnsigned(iM779constructorimpl3, iM779constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM779constructorimpl3;
        }
        return UInt.m773boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM858constructorimpl = ULong.m858constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM858constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM858constructorimpl2 = ULong.m858constructorimpl(j * jM858constructorimpl);
            long jM858constructorimpl3 = ULong.m858constructorimpl(ULong.m858constructorimpl(((long) UInt.m779constructorimpl(iDigitOf)) & 4294967295L) + jM858constructorimpl2);
            if (Long.compareUnsigned(jM858constructorimpl3, jM858constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM858constructorimpl3;
        }
        return ULong.m852boximpl(j);
    }
}
