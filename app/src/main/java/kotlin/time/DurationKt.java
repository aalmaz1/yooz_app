...
public final class DurationKt {
    ...
    private static final long m2137timesmvk6XK0(int i, long j) {
        return Duration.m2048timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2136timeskIfJnKk(double d, long j) {
        return Duration.m2047timesUwyO8pc(j, d);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2010constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2010constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2010constructorimpl((j << 1) + ((long) i));
    }
