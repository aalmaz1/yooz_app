...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2001minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2147minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo2000elapsedNowUwyO8pc() {
        return Duration.m2045minusLRDsOJo(this.mark.mo2000elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2003plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2046plusLRDsOJo(this.adjustment, duration), null);
    }
}
