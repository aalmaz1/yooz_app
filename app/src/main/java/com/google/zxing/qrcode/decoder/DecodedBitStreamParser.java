...
final class DecodedBitStreamParser {
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x012b A[LOOP:0: B:64:0x0022->B:61:0x012b, LOOP_END] */
    ...
    */
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        ...
        while (i > 0) {
            int bits = bitSource.readBits(13);
            int i3 = (bits % Constant.MESSAGE_ID_INIT_NFC) | ((bits / Constant.MESSAGE_ID_INIT_NFC) << 8);
    ...
    */
    ...
    private static int parseECIValue(BitSource bitSource) throws FormatException {
        ...
        if ((bits & Constant.MESSAGE_ID_INIT_NFC) == 128) {
