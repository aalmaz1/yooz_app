...
final class zzef implements zzhv {
    ...
    @Override // com.google.android.gms.internal.play_billing.zzhv
    public final void zzd(int i, zzdw zzdwVar) throws IOException {
        this.zza.zze(i, zzdwVar);
    }
    ...
    @Override // com.google.android.gms.internal.play_billing.zzhv
    public final void zzq(int i, Object obj, zzgm zzgmVar) throws IOException {
    ...
    @Override // com.google.android.gms.internal.play_billing.zzhv
    public final void zzv(int i, Object obj, zzgm zzgmVar) throws IOException {
    ...
    public final void zzG(int i, List list) throws IOException {
        ...
        while (i2 < list.size()) {
            Object objZzf = zzfkVar.zzf(i2);
            if (objZzf instanceof String) {
                this.zza.zzm(i, (String) objZzf);
            } else {
                this.zza.zze(i, (zzdw) objZzf);
            }
            i2++;
        }
    }
    ...
    public final void zzI(int i, List list, boolean z) throws IOException {
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzx += zzee.zzx(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzx);
        while (i2 < list.size()) {
    ...
    public final void zzK(int i, List list, boolean z) throws IOException {
        ...
        int iZzy = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzy += zzee.zzy(((Long) list.get(i3)).longValue());
        }
        this.zza.zzq(iZzy);
        while (i2 < list.size()) {
    ...
    public final void zzs(int i, List list, boolean z) throws IOException {
        ...
        int iZzu = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzu += zzee.zzu(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzu);
        while (i2 < list.size()) {
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzeeVar.zzp(i, (iIntValue >> 31) ^ (iIntValue + iIntValue));
                i2++;
            }
            return;
        }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzeeVar.zzr(i, (jLongValue >> 63) ^ (jLongValue + jLongValue));
                i2++;
            }
            return;
        }
