...
public enum zzep {
    ...
    static {
        zzep[] zzepVarArrValues = values();
        zzZ = new zzep[zzepVarArrValues.length];
        for (zzep zzepVar : zzepVarArrValues) {
            zzZ[zzepVar.zzac] = zzepVar;
        }
    }

    zzep(int i, int i2, zzfg zzfgVar) {
        this.zzac = i;
        this.zzab = zzfgVar;
        int i3 = i2 - 1;
        if (i3 == 1 || i3 == 3) {
