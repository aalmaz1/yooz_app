...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    public static RegisterRequest parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                try {
                    return new RegisterRequest(ProtocolVersion.fromString(jSONObject.has(IMAPStore.ID_VERSION) ? jSONObject.getString(IMAPStore.ID_VERSION) : null), Base64.decode(jSONObject.getString(ClientData.KEY_CHALLENGE), 8), jSONObject.has("appId") ? jSONObject.getString("appId") : null);
    ...
    public JSONObject toJson() {
        ...
        try {
            jSONObject.put(IMAPStore.ID_VERSION, this.zzb.toString());
