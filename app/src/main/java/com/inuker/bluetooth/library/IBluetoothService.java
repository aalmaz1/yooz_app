...
public interface IBluetoothService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothService {
        ...
        public static IBluetoothService asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBluetoothService)) {
                return (IBluetoothService) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            callBluetoothApi(i3, bundle, IResponse.Stub.asInterface(parcel.readStrongBinder()));
        ...
        private static class Proxy implements IBluetoothService {
            ...
            public void callBluetoothApi(int i, Bundle bundle, IResponse iResponse) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeStrongBinder(iResponse != null ? iResponse.asBinder() : null);
