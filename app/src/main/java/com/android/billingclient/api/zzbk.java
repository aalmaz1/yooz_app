...
final class zzbk {
    ...
    static {
        ...
        builderNewBuilder30.setDebugMessage("Play Store version installed does not support alternative billing only.");
        zzD = builderNewBuilder30.build();
        BillingResult.Builder builderNewBuilder31 = BillingResult.newBuilder();
        builderNewBuilder31.setResponseCode(5);
        builderNewBuilder31.setDebugMessage("To use this API you must specify a PurchasesUpdateListener when initializing a BillingClient.");
