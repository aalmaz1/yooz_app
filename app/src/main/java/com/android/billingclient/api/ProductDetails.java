...
public final class ProductDetails {
    ...
    public static final class OneTimePurchaseOfferDetails {
        ...
        OneTimePurchaseOfferDetails(JSONObject jSONObject) throws JSONException {
            ...
            this.zzh = jSONObjectOptJSONObject == null ? null : new zzbz(jSONObjectOptJSONObject);
            JSONObject jSONObjectOptJSONObject2 = jSONObject.optJSONObject("validTimeWindow");
            this.zzi = jSONObjectOptJSONObject2 == null ? null : new zzcc(jSONObjectOptJSONObject2);
            JSONObject jSONObjectOptJSONObject3 = jSONObject.optJSONObject("limitedQuantityInfo");
            this.zzj = jSONObjectOptJSONObject3 == null ? null : new zzca(jSONObjectOptJSONObject3);
            JSONObject jSONObjectOptJSONObject4 = jSONObject.optJSONObject("preorderDetails");
            this.zzk = jSONObjectOptJSONObject4 != null ? new zzcb(jSONObjectOptJSONObject4) : null;
        }
    ...
    public static final class SubscriptionOfferDetails {
        ...
        SubscriptionOfferDetails(JSONObject jSONObject) throws JSONException {
            ...
            this.zzf = jSONObjectOptJSONObject != null ? new zzby(jSONObjectOptJSONObject) : null;
            ArrayList arrayList = new ArrayList();
            JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray("offerTags");
            if (jSONArrayOptJSONArray != null) {
                for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
    ...
    ProductDetails(String str) throws JSONException {
        ...
        String strOptString2 = jSONObject.optString(NotificationManager.BUNDLE_TYPE);
