...
public class NotificationTarget extends CustomTarget<Bitmap> {
    ...
    private void update() {
        ((NotificationManager) Preconditions.checkNotNull((NotificationManager) this.context.getSystemService(cn.yoozworld.watch.utils.notifi.NotificationManager.BUNDLE_NOTIFICATION))).notify(this.notificationTag, this.notificationId, this.notification);
    }
