...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:29:0x0063 A[Catch: all -> 0x006e, TRY_LEAVE, TryCatch #2 {all -> 0x006e, blocks: (B:27:0x005d, B:29:0x0063), top: B:41:0x005d }] */
    /* JADX WARN: Removed duplicated region for block: B:31:0x006a A[DONT_GENERATE] */
    /*
    ...
    */
    private boolean isUnsupportedFormat(T r7, android.media.MediaMetadataRetriever r8) {
        ...
        L18:
            r1 = 12
            r4 = 0
            java.lang.String r8 = r8.extractMetadata(r1)     // Catch: java.lang.Throwable -> L5b
            java.lang.String r1 = "video/webm"
            boolean r8 = r1.equals(r8)     // Catch: java.lang.Throwable -> L5b
            if (r8 != 0) goto L29
            return r3
        L29:
            android.media.MediaExtractor r8 = new android.media.MediaExtractor     // Catch: java.lang.Throwable -> L5b
            r8.<init>()     // Catch: java.lang.Throwable -> L5b
            com.bumptech.glide.load.resource.bitmap.VideoDecoder$MediaInitializer<T> r1 = r6.initializer     // Catch: java.lang.Throwable -> L58
            r1.initializeExtractor(r8, r7)     // Catch: java.lang.Throwable -> L58
            int r7 = r8.getTrackCount()     // Catch: java.lang.Throwable -> L58
            r1 = r3
        L38:
            if (r1 >= r7) goto L54
            android.media.MediaFormat r4 = r8.getTrackFormat(r1)     // Catch: java.lang.Throwable -> L58
            java.lang.String r5 = "mime"
            java.lang.String r4 = r4.getString(r5)     // Catch: java.lang.Throwable -> L58
        ...
        L5c:
            r8 = 3
            boolean r8 = android.util.Log.isLoggable(r0, r8)     // Catch: java.lang.Throwable -> L6e
            if (r8 == 0) goto L68
            java.lang.String r8 = "Exception trying to extract track info for a webm video on CrOS."
            android.util.Log.d(r0, r8, r7)     // Catch: java.lang.Throwable -> L6e
        L68:
            if (r4 == 0) goto L6d
            r4.release()
        L6d:
