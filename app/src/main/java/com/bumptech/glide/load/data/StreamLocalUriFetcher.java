...
public class StreamLocalUriFetcher extends LocalUriFetcher<InputStream> {
    ...
    static {
        ...
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "contacts/lookup/*/#", 1);
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "contacts/lookup/*", 1);
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "contacts/#/photo", 2);
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "contacts/#", 3);
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "contacts/#/display_photo", 4);
        uriMatcher.addURI(Constant.PACKAGE_NAME_CONTACTS, "phone_lookup/*", 5);
    }
