...
public class JsonUtils {
        ...
        try {
            ...
            while (true) {
                ...
                if (line != null) {
                    ...
                    SharePreferenceUtils.saveStringByKey(context, Constant.DEVICE_CONFIG_ALL, new Gson().toJson((ArrayList) new Gson().fromJson(sb.toString(), new TypeToken<ArrayList<DeviceBean>>() { // from class: cn.baos.watch.sdk.util.JsonUtils.1
                    }.getType())));
                    return;
                }
            }
    ...
    public static DeviceBean getCurrentDeviceConfig(Context context) {
        ...
        if (!StringUtils.isBlank(strQueryStringByKey) && !StringUtils.isBlank(strQueryStringByKey2)) {
            ...
            ArrayList<DeviceBean> arrayList = (ArrayList) new Gson().fromJson(strQueryStringByKey, new TypeToken<ArrayList<DeviceBean>>() { // from class: cn.baos.watch.sdk.util.JsonUtils.2
            }.getType());
