package cn.baos.watch.sdk.code.callcontroller;
...
public class CallStateManager {
    ...
    public void quietCallOff() {
        Executors.newSingleThreadScheduledExecutor().schedule(new Runnable() { // from class: cn.baos.watch.sdk.code.callcontroller.CallStateManager.1
