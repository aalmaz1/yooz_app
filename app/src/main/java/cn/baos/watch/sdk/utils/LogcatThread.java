...
public class LogcatThread extends Thread {
    ...
    */
    ...
    public void cleanLogFiles() {
        ...
        Collections.sort(listAsList, new Comparator<File>() { // from class: cn.baos.watch.sdk.utils.LogcatThread.1
    ...
    */
    private void writeTofile(java.lang.String r10) throws java.lang.Throwable {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.baos.watch.sdk.utils.LogcatThread.writeTofile(java.lang.String):void");
    }
