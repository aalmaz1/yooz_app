...
public class HuabaoSdkFactory {
    ...
    /* JADX INFO: renamed from: cn.baos.watch.sdk.old.HuabaoSdkFactory$1, reason: invalid class name */
    ...
    public static BleSdkWrapper createMessage(SdkType sdkType) {
        int i = AnonymousClass1.$SwitchMap$cn$baos$watch$sdk$old$HuabaoSdkFactory$SdkType[sdkType.ordinal()];
        if (i == 1) {
