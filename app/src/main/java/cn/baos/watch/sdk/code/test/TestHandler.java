package cn.baos.watch.sdk.code.test;
...
public class TestHandler extends Handler {
    ...
    private TestHandler() {
        ...
        this.number_fail = 0;
        this.smallPackageTimeOutRunnable = new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.1
            @Override // java.lang.Runnable
            public void run() {
                new Thread(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.1.1
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        this.monkeyTestRunnable = new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.2
            @Override // java.lang.Runnable
            public void run() {
                new Thread(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.2.1
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        this.randomCommandTestRunnable = new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.3
            @Override // java.lang.Runnable
            public void run() {
                new Thread(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.3.1
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        this.asrTestTimeOutStartRunnable = new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.4
            @Override // java.lang.Runnable
            public void run() {
                new Thread(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.4.1
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        this.asrTestPlayAudioRunnable = new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.5
            @Override // java.lang.Runnable
            public void run() {
                new Thread(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.5.1
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public void openAssets() {
        try {
            ...
            MainHandler.getInstance().postDelayed(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler.6
                @Override // java.lang.Runnable
                public void run() {
    ...
    /* JADX INFO: renamed from: cn.baos.watch.sdk.code.test.TestHandler$7, reason: invalid class name */
    class AnonymousClass7 implements TranslateCallback {
        ...
        public void onTransferFinish() {
            ...
            if (TestHandler.this.progress >= 99) {
                ...
                mainHandler.postDelayed(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler$7$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
        ...
        public void onTransferFail(int i) {
            ...
            mainHandler.postDelayed(new Runnable() { // from class: cn.baos.watch.sdk.code.test.TestHandler$7$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
