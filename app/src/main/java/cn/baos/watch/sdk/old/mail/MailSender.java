...
public class MailSender {
    ...
    private Message createAttachmentMail(final MailInfo mailInfo, File file) throws MessagingException, UnsupportedEncodingException {
        MimeMessage mimeMessage = new MimeMessage(Session.getInstance(mailInfo.getProperties(), new Authenticator() { // from class: cn.baos.watch.sdk.old.mail.MailSender.1
