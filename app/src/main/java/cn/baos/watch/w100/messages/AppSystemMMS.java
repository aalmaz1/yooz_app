...
public class AppSystemMMS extends MessageBase {
    ...
    @Override // cn.baos.watch.w100.messages.MessageBase, cn.baos.message.Serializable
    public AppSystemMMS load(MessageUnpacker messageUnpacker) throws IOException {
    ...
    public AppSystemMMS() {
        this.catagory = CatagoryEnum.APPSYSTEMMMS;
    }
}
