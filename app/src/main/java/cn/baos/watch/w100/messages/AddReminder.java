...
public class AddReminder extends MessageBase {
    ...
    @Override // cn.baos.watch.w100.messages.MessageBase, cn.baos.message.Serializable
    public AddReminder load(MessageUnpacker messageUnpacker) throws IOException {
    ...
    public AddReminder() {
        this.catagory = CatagoryEnum.ADDREMINDER;
    }
}
