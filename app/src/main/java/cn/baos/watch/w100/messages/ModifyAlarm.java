...
public class ModifyAlarm extends MessageBase {
    public int alarm_id;
    ...
    @Override // cn.baos.watch.w100.messages.MessageBase, cn.baos.message.Serializable
    public ModifyAlarm load(MessageUnpacker messageUnpacker) throws IOException {
    ...
    public ModifyAlarm() {
        this.catagory = CatagoryEnum.MODIFYALARM;
    }
}
