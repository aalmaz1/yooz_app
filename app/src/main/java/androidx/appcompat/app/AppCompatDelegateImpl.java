    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & Constant.MESSAGE_ID_INIT_NFC) != (configuration2.screenLayout & Constant.MESSAGE_ID_INIT_NFC)) {
                configuration3.screenLayout |= configuration2.screenLayout & Constant.MESSAGE_ID_INIT_NFC;
            }
