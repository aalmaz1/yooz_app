...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo324clone = transition.mo324clone();
        transitionMo324clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo324clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo324clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo324clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo324clone = transition.mo324clone();
        sceneChangeSetup(viewGroup, transitionMo324clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo324clone);
    }
