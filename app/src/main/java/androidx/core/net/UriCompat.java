...
public final class UriCompat {
    ...
    public static String toSafeString(Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase(DatabaseHelper.CONTACTS_COLUMN_TEL) || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {
