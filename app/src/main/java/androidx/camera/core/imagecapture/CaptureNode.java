...
class CaptureNode implements Node<In, Out> {
    ...
    public Out transform(In in) {
        ...
        if ((true ^ in.isVirtualCamera()) && in.getImageReaderProxyProvider() == null) {
            ...
            consumer = new Consumer() { // from class: androidx.camera.core.imagecapture.CaptureNode$$ExternalSyntheticLambda2
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.m141lambda$transform$0$androidxcameracoreimagecaptureCaptureNode(noMetadataImageReader, (ProcessingRequest) obj);
                }
            };
        ...
        imageReaderProxy.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.imagecapture.CaptureNode$$ExternalSyntheticLambda3
            @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy2) {
                this.f$0.m142lambda$transform$1$androidxcameracoreimagecaptureCaptureNode(imageReaderProxy2);
            }
    ...
    /* synthetic */ void m141lambda$transform$0$androidxcameracoreimagecaptureCaptureNode(NoMetadataImageReader noMetadataImageReader, ProcessingRequest processingRequest) {
    ...
    /* synthetic */ void m142lambda$transform$1$androidxcameracoreimagecaptureCaptureNode(ImageReaderProxy imageReaderProxy) {
        try {
