...
public final class ProcessCameraProvider implements LifecycleCameraProvider {
        ...
        synchronized (this.mLock) {
            ...
            ListenableFuture<CameraX> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.lifecycle.ProcessCameraProvider$$ExternalSyntheticLambda4
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m191x6ee14178(cameraX, completer);
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$getOrCreateCameraXInstance$2$androidx-camera-lifecycle-ProcessCameraProvider, reason: not valid java name */
    /* synthetic */ Object m191x6ee14178(final CameraX cameraX, final CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
    ...
    /* JADX INFO: renamed from: lambda$shutdown$4$androidx-camera-lifecycle-ProcessCameraProvider, reason: not valid java name */
    /* synthetic */ void m192x331eedbd() {
        unbindAll();
