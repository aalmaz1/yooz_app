...
class QualityRatioToResolutionsTable {
    ...
    static {
        ...
        map.put(Quality.HD, Range.create(Integer.valueOf(ResolutionCameraConfig.IMAGE_QUALITY_720P), Integer.valueOf(Constant.MESSAGE_INTEGRATION_TEST_ID_SYNC_TIME_TIME_OUT)));
