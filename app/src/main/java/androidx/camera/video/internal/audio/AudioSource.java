...
public final class AudioSource {
    ...
    public void setBufferProvider(final BufferProvider<? extends InputBuffer> bufferProvider) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m225x885db6e2(bufferProvider);
            }
        });
    }
    ...
    /* synthetic */ void m225x885db6e2(BufferProvider bufferProvider) {
    ...
    /* synthetic */ void m226lambda$start$1$androidxcameravideointernalaudioAudioSource() {
        start(this.mMuted);
    }
    ...
    public void start() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m226lambda$start$1$androidxcameravideointernalaudioAudioSource();
            }
        });
    }
    ...
    public void start(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m227lambda$start$2$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$start$2$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m227lambda$start$2$androidxcameravideointernalaudioAudioSource(boolean z) {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i != 1) {
            if (i == 3) {
                throw new AssertionError("AudioSource is released");
    ...
    public void stop() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m228lambda$stop$3$androidxcameravideointernalaudioAudioSource();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$stop$3$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m228lambda$stop$3$androidxcameravideointernalaudioAudioSource() {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i == 2) {
    ...
    public ListenableFuture<Void> release() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda7
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m223xa561a489(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$release$5$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ Object m223xa561a489(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m222xb3b7fe6a(completer);
            }
        });
    ...
    /* synthetic */ void m222xb3b7fe6a(CallbackToFutureAdapter.Completer completer) {
        try {
            int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public void setAudioSourceCallback(final Executor executor, final AudioSourceCallback audioSourceCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m224xcbe526c1(executor, audioSourceCallback);
            }
        });
    }
    ...
    /* synthetic */ void m224xcbe526c1(Executor executor, AudioSourceCallback audioSourceCallback) {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: androidx.camera.video.internal.audio.AudioSource$3, reason: invalid class name */
    ...
    public void mute(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m220lambda$mute$7$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$mute$7$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m220lambda$mute$7$androidxcameravideointernalaudioAudioSource(boolean z) {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i != 1 && i != 2) {
            if (i == 3) {
                throw new AssertionError("AudioSource is released");
    ...
    void postMaxAmplitude(ByteBuffer byteBuffer) {
        ...
        if (this.mAudioFormat == 2) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m221xdf9dee1c(audioSourceCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m221xdf9dee1c(AudioSourceCallback audioSourceCallback) {
