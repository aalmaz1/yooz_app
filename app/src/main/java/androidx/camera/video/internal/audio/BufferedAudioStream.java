...
public class BufferedAudioStream implements AudioStream {
    ...
    public void start() throws IllegalStateException, AudioStream.AudioStreamException {
        ...
        FutureTask futureTask = new FutureTask(new Runnable() { // from class: androidx.camera.video.internal.audio.BufferedAudioStream$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m232x4e044ff9();
            }
        }, null);
    ...
    public void release() {
        ...
        this.mProducerExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.BufferedAudioStream$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m230x4385f432();
            }
        });
    }
    ...
    public void setCallback(final AudioStream.AudioStreamCallback audioStreamCallback, final Executor executor) {
        ...
        this.mProducerExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.BufferedAudioStream$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m231xf8dcf611(audioStreamCallback, executor);
            }
        });
    }
    ...
    /* synthetic */ void m231xf8dcf611(AudioStream.AudioStreamCallback audioStreamCallback, Executor executor) {
    ...
    public void m234x75a1ac03(int i) {
