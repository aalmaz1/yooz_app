...
public class ContentType {
    ...
    public String getBaseType() {
        return (this.primaryType == null || this.subType == null) ? "" : this.primaryType + IOUtils.DIR_SEPARATOR_UNIX + this.subType;
    }
    ...
    public String toString() {
        ...
        sb.append(this.primaryType).append(IOUtils.DIR_SEPARATOR_UNIX).append(this.subType);
        ParameterList parameterList = this.list;
        if (parameterList != null) {
    ...
    public boolean match(ContentType contentType) {
        ...
        if ((str2 != null && str2.startsWith(ProxyConfig.MATCH_ALL_SCHEMES)) || (subType != null && subType.startsWith(ProxyConfig.MATCH_ALL_SCHEMES))) {
            return true;
        }
