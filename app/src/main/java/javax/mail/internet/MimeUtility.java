...
public class MimeUtility {
    ...
    static {
        ...
        if (java2mime.isEmpty()) {
            java2mime.put("8859_1", CharEncoding.ISO_8859_1);
            java2mime.put("iso8859_1", CharEncoding.ISO_8859_1);
            java2mime.put("iso8859-1", CharEncoding.ISO_8859_1);
        ...
        if (mime2java.isEmpty()) {
            ...
            mime2java.put("us-ascii", CharEncoding.ISO_8859_1);
            mime2java.put("x-us-ascii", CharEncoding.ISO_8859_1);
    ...
    */
    public static java.lang.String getEncoding(javax.activation.DataSource r6) {
        ...
        L2a:
            r5 = -1
            int r4 = checkAscii(r1, r5, r4)     // Catch: java.lang.Throwable -> L49 java.lang.Exception -> L50
            if (r4 == r3) goto L41
            r3 = 2
            if (r4 == r3) goto L35
            goto L43
    ...
    public static String decodeText(String str) throws UnsupportedEncodingException {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (cCharAt == ' ' || cCharAt == '\t' || cCharAt == '\r' || cCharAt == '\n') {
                ...
                try {
                    strDecodeInnerWords = decodeWord(strNextToken);
                    ...
                    if (!decodeStrict) {
                        strDecodeInnerWords = decodeInnerWords(strNextToken);
    ...
    private static void doEncode(String str, boolean z, String str2, int i, String str3, boolean z2, boolean z3, StringBuilder sb) throws UnsupportedEncodingException {
        ...
        if (z) {
            iEncodedLength = BEncoderStream.encodedLength(bytes);
        } else {
            iEncodedLength = QEncoderStream.encodedLength(bytes, z3);
        }
        if (iEncodedLength > i && (length = str.length()) > 1) {
            int i2 = length / 2;
    ...
    public static String decodeWord(String str) throws ParseException, UnsupportedEncodingException {
        ...
        try {
            ...
            if (strSubstring3.length() > 0) {
                ...
                } else if (strSubstring2.equalsIgnoreCase("Q")) {
        ...
        while (true) {
            ...
            if (iIndexOfAny > 0) {
                ...
                if (str.charAt(i2) == '\\') {
                    ...
                    sb.append(str.substring(iIndexOfAny, i));
                    str = str.substring(i);
                }
            }
        ...
        while (i2 != 0) {
            try {
                ...
                while (i9 < i8) {
                    ...
                    if (z2 && ((i3 == 13 && i10 != 10) || (i3 != 13 && i10 == 10))) {
                        z3 = true;
                    }
                    if (i10 == 13 || i10 == 10) {
                        i7 = 0;
